...
<div class="container-fluid">
    ...
    <button type="button" id="add_sub_tree" class="btn btn-primary my-2" data-toggle="modal" data-target="#modal-lg">
        Add Sub Menu Tree
    </button>
    <div class="card">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <button class="btn btn-success" id="edit_sub_tree" data-id_tree="<?= $dum['id_tree']; ?>" data-id="<?= $dum['menu_id']; ?>" data-title="<?= $dum['title']; ?>" data-url="<?= $dum['url']; ?>" data-icon="<?= $dum['icon']; ?>" data-badges="<?= $dum['is_badges']; ?>" data-active="<?= $dum['is_active']; ?>" data-uniq="<?= $dum['uniq_key']; ?>" data-toggle="modal" data-target="#modal-lg"><i class="fas fa-edit"></i></button>
                                    </div>
                                    <div class="col-6">

                                        <a href="<?= base_url(); ?>menu_management/tree/del/<?= $dum['uniq_key']; ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="menu_id" id="menu_id">
                                    ...
                                    <?php foreach ($user_menu as $um) : ?>
                                        <option value="<?= $um['menu_id'] . ',' . $um['id_tree'] ?>"><?= $um['title']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <?= form_error('menu_id', '<small id="notiffff" class="mx-2 text-danger"><cite>', '</cite></small>'); ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <?= form_error('title', '<small id="notiffff" class="mx-2 text-danger"><cite>', '</cite></small>'); ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <?= form_error('url', '<small id="notiffff" class="mx-2 text-danger"><cite>', '</cite></small>'); ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <?= form_error('icon', '<small id="notiffff" class="mx-2 text-danger"><cite>', '</cite></small>'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
